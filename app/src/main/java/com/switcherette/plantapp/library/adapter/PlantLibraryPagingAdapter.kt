package com.switcherette.plantapp.library
...
import com.switcherette.plantapp.databinding.ItemPlantLibraryBinding
import com.switcherette.plantapp.databinding.ItemSearchPlantBynameBinding

class PlantLibraryPagingAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PagingViewHolder {
        val binding = ItemPlantLibraryBinding
...
class PagingViewHolder(private val binding: ItemPlantLibraryBinding): RecyclerView.ViewHolder(binding.root){
